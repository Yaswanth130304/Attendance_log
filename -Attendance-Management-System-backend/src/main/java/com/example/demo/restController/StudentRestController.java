...
public class StudentRestController {
	...
	public Student addStudent(@RequestBody Student student) {
		...
		Student savedStudent= studentService.saveNewStudents(student);
		User user=new User();
	...
	@CrossOrigin(exposedHeaders="Access-Control-Allow-Origin")
	public Student getStudentDetails(@RequestParam String email) {
		return studentService.fetchByEmail(email);
	}
